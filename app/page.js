          ...
          >
            ...
            <div>
              ...
              <p className="text-[#94a3b8] leading-relaxed mb-4">
                Препод кидает список литературы на 20 книг. Ты скачиваешь PDF, читаешь пару вечеров, закрываешь файл... и через месяц не можешь вспомнить даже сюжет. Тратишь время, а на экзамене или собеседовании не можешь опереться на эти знания.
              </p>
      ...
      <section className="py-20 px-6 relative z-10">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="bg-[#0d1a2e] p-8 rounded-2xl border border-[#162236] hover:border-[#1a56db]/50 transition-all duration-300 group">
            ...
            <p className="text-[#4a6080] text-sm leading-relaxed">
              Админ проверяет твой отчет. Книга переходит в статус "Прочитано". Ты действительно усвоил материал, а не просто пролистал страницы.
            </p>
          </motion.div>
        </motion.div>
      </section>
